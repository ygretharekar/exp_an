...
class _MonthPickerState extends State<MonthPicker> {
  ...
  void initState() {
    ...
    final int monthPage = _monthDelta(widget.firstDate, widget.selectedDates[0]);
        ...
        children: <Widget>[
          new Semantics(
            ...
            child: new PageView.builder(
              key: new ValueKey<List<DateTime>>(widget.selectedDates),
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void _handleModeChanged(DatePickerMode mode) {
    ...
    setState(() {
      ...
      if (_mode == DatePickerMode.day) {
        SemanticsService.announce(localizations.formatMonthYear(_selectedDates[0]), textDirection);
      } else {
        SemanticsService.announce(localizations.formatYear(_selectedDates[0]), textDirection);
      }
    });
  }
  ...
  void _handleDayChanged(DateTime value) {
    ...
    _selectedDates.forEach(
        (selectedDate) {
          present = (selectedDate == value) || present;
        }
        //
    );
    ...
    setState(() {
      if(!present) _selectedDates.add(value);
